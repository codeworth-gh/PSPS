...
PSPS users https://getbootstrap.com[Bootstrap 4] for its page templates. The menu:views package contains many facilities for supporting common HTML use-cases -- most of them detailed here.
